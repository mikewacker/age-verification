...
final class AvsApiEndpointHandler implements HttpHandler {
    ...
    private void handleVerificationSession(HttpServerExchange exchange, RequestParser parser) throws Exception {
    ...
    private void handleLinkedVerificationRequest(HttpServerExchange exchange, RequestParser parser) throws Exception {
    ...
    private void handleAgeCertificate(HttpServerExchange exchange) throws Exception {
        StatusCodeSender sender = UndertowStatusCodeSender.create(exchange);
