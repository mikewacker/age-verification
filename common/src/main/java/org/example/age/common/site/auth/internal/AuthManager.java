...
public interface AuthManager {
    ...
    /** Called when a {@link VerificationSession} is received as part of an exchange. */
    void onVerificationSessionReceived(VerificationSession session, HttpServerExchange exchange);
