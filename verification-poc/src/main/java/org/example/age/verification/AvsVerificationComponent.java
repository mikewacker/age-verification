...
public final class AvsVerificationComponent implements AvsUi, AvsApi, VerifiedUserStore {
     ...
     * Registers a site.
     *
     * <p>The remote site ID key is generated by the age verification service; it is not shared with the site.</p>
     */
    public void registerSite(
            String siteId, SiteApi certificateProcessor, AgeThresholds ageThresholds, SecureId remoteSiteIdKey) {
        Site siteInfo = new Site(siteId, certificateProcessor, ageThresholds, remoteSiteIdKey);
    ...
    private AgeCertificate createAgeCertificateForSite(VerifiedUser user, VerificationRequest request, Site site) {
        VerifiedUser localUser = user.anonymizeAge(site.ageThresholds()).localize(site.remoteIdKey());
    ...
    private record Site(String id, SiteApi api, AgeThresholds ageThresholds, SecureId remoteIdKey) {}
}
